    ...
    return (
        <div>
            <div className="relative movieDetail">
                <div
                    className=" bg-no-repeat bg-cover absolute top-0 left-0 w-full h-full movieDetail_bg"
                ...
                <div className="grid grid-cols-12 gap-[20px] px-[10px] sm:px-[30px] relative p-11">
                    ...
                    <div className="lg:col-span-9 col-span-12 movieDetail_info px-[20px]">
                        <h3 className="mb-4 text-4xl font-600 leading-none tracking-tight text-gray-300 dark:text-black ">
                            {movieDetail?.tenPhim}
                        </h3>
                        <hr className="my-10" />
            ...
            <div className="my-10 p-20 ">
                ...
                <div className="grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-[10px] justify-center ">
                    {movieList ? (
                        movieList
